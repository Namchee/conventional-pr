...
| `template`            | `false`       | `''`                                      | Comment template to use when commenting on invalid pull requests. Fill with an empty string to disable extra comments (this **will not** disable validation report, please use `report` option for that)                                                                                                                                                                                                   |
