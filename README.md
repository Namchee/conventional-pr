...
| `timeout` | `false` | `5` | Timeout for API requests (e.g: GitHub API). May be defined as an integer (seconds) or duration string containing the unit of measurement. Please refer to [Go's `parseDuration`](https://pkg.go.dev/time#ParseDuration) signature for list of valid human-readable formats. | 
